...
<%
	...
	int limitStartPage = (int) request.getAttribute("limitStartPage");
	int limitEndPage = (int) request.getAttribute("limitEndPage");
%>
...
<body>
	...
	<div class="paging">
		...
		<% } %>
		<% for(int i = limitStartPage; i <= limitEndPage; i++) { %>
